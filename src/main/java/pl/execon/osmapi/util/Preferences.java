...
public class Preferences {
	...
	public static final String DEVELOPMENT_OSM_CREDENTIALS_LOGIN = "PLEASE_PROVIDE_LOGIN"; // DEVELOPMENT
	public static final String DEVELOPMENT_OSM_CREDENTIALS_PASS = "PLEASE_PROVIDE_PASS"; // DEVELOPMENT
